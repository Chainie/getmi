...
import static cz.gadger.gtmi.instructions.BasicInstructionFactory.createForType;
import static cz.gadger.gtmi.instructions.BasicInstructionFactory.createForTypeWithoutPointerPostIncrement;
import static cz.gadger.gtmi.instructions.InstructionType.*;

/**
 * Factory for creating whole instruction sets.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public class InstructionsSetFactory {
    ...
    public static InstructionsSetFactory builder() {
        return new InstructionsSetFactory();
    }

    public InstructionsSetFactory addInstructionSet(Set<Instruction> instructionSet) {
    ...
    public static Map<Character, Instruction> forInstructionSetTypes(List<InstructionSetType> types) {
        InstructionsSetFactory builder = InstructionsSetFactory.builder();
